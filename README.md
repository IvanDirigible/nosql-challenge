...
```md
AS A data analyst
I WANT to evaluate restaurant ratings data 
SO THAT I can assist journalists and food critics.
```

## Acceptance Criteria
```md
Part 1: Database and Jupyter Notebook Set Up
* Ensure the Jupyter Notebook setup file has the following:
...
* Ensure the Jupyter Notebook analysis file has the following:
